                ...
                container.Page(page =>
                {
                    ...
                    page.Header()
                        .Column(column =>
                        {
                            ...
                            column.Item()
                                .Text(
                                    $"Responsable: {report.AppliedFilters.Assignee}");

                            column.Item()
                                .Text(
                                    $"Prioridad: {report.AppliedFilters.Priority}");

                            column.Item()
                                .Text(
                                    $"Búsqueda: {report.AppliedFilters.Search}");
                        });
                        ...
                        .Table(table =>
                        {
                            ...
                            if (report.Tasks.Count == 0)
                            {
                                table.Cell()
                                    ...
                                    .AlignCenter()
                                    .Text(
                                        report.AppliedFilters.HasActiveFilters
