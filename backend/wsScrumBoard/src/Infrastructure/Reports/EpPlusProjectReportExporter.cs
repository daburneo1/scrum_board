...
{
    private const int TaskHeaderRow = 14;
        ...
        ProjectReportDto report)
    {
        ...
        AddMetadataRow(
            ...
            11,
            "Responsable",
            report.AppliedFilters.Assignee);

        AddMetadataRow(
            worksheet,
            12,
            "Prioridad",
            report.AppliedFilters.Priority);

        AddMetadataRow(
            worksheet,
            13,
            "Búsqueda",
            report.AppliedFilters.Search);
    }
        ...
        ProjectReportDto report)
    {
        ...
        if (report.Tasks.Count == 0)
        {
            ...
            emptyRange.Value = report.AppliedFilters.HasActiveFilters
                ? "No existen tareas para los filtros seleccionados."
